...
export async function acceptFriendRequest(requestId) {
    try {
      const res = await fetch(`${API_URL}/api/friends/${requestId}/accept`, {
        method: 'PUT',
      });
  ...
  export async function rejectFriendRequest(requestId) {
    try {
      const res = await fetch(`${API_URL}/api/friends/${requestId}/reject`, {
        method: 'PUT',
      });
  ...
  export async function fetchFriendRequests(userId) {
    try {
      const res = await fetch(`${API_URL}/api/friends/requests/${userId}`);
